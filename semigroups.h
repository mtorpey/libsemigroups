...
class Semigroup {
 ...
 public:
  ...
  // Of course the same effect can be obtained by copying <copy> using the copy
  ...
  // non-const
  // @limit    the number of elements to enumerate
  // @report   report during enumeration, if any (defaults to
  // <DEFAULT_REPORT_VALUE>)
  //
  ...
  void enumerate(size_t limit, bool report = DEFAULT_REPORT_VALUE);
